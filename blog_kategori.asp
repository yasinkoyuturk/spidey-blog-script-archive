...
sor = "SELECT * FROM makale_alt_kategoriler where onayli=True and kate_id="&kategori&" order by id desc"
alt.Open sor,bag,1,3

if alt.eof then
%>
<center><br><br><br><br><br><br><br><br><br><br><br><hr style="border: 1px dotted #C0C0C0" width="97%" size="1"><span class="normal_ryazi">Bu kategoride kayýtlý yazý bulunmuyor</span><br><hr style="border: 1px dotted #C0C0C0" width="97%" size="1"><br><br></center>
<%
else
yok=alt.recordcount
