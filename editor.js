...
this.imgURL = _editor_url + 'resimler/';
this.debug  = 0;
...
this.btnList = {
    ...
    "bold":           ['Bold',                 'Kalýn',               		'editor_action(this.id)',  'ed_format_bold.gif'],
    "italic":         ['Italic',               'Italik',        	     'editor_action(this.id)',  'ed_format_italic.gif'],
    "underline":      ['Underline',            'Altý Çizili',          'editor_action(this.id)',  'ed_format_underline.gif'],
    "strikethrough":  ['StrikeThrough',        'Sola Dayalý',      'editor_action(this.id)',  'ed_format_strike.gif'],
    "subscript":      ['SubScript',            'Ortala',          'editor_action(this.id)',  'ed_format_sub.gif'],
    "superscript":    ['SuperScript',          'Superscript',        'editor_action(this.id)',  'ed_format_sup.gif'],
    "justifyleft":    ['JustifyLeft',          'Sola hizala',       'editor_action(this.id)',  'ed_align_left.gif'],
    "justifycenter":  ['JustifyCenter',        'Ortala',     'editor_action(this.id)',  'ed_align_center.gif'],
    "justifyright":   ['JustifyRight',         'Saða hizala',      'editor_action(this.id)',  'ed_align_right.gif'],
    "orderedlist":    ['InsertOrderedList',    'Rakamla maddele',       'editor_action(this.id)',  'ed_list_num.gif'],
    "unorderedlist":  ['InsertUnorderedList',  'Noktalarla Maddele',      'editor_action(this.id)',  'ed_list_bullet.gif'],
    "outdent":        ['Outdent',              'Bir satýr içeri',    'editor_action(this.id)',  'ed_indent_less.gif'],
    "indent":         ['Indent',               'Bir satýr dýþarý',    'editor_action(this.id)',  'ed_indent_more.gif'],
    "forecolor":      ['ForeColor',            'Yazý Rengi',         'editor_action(this.id)',  'ed_color_fg.gif'],
    "backcolor":      ['BackColor',            'Arkalan rengi',   'editor_action(this.id)',  'ed_color_bg.gif'],
    "horizontalrule": ['InsertHorizontalRule', 'Yatay Çizgi',    'editor_action(this.id)',  'ed_hr.gif'],
    "createlink":     ['CreateLink',           'Link ekle',    'editor_action(this.id)',  'ed_link.gif'],
    "insertimage":    ['InsertImage',          'Resim Ekle',       'editor_action(this.id)',  'ed_image.gif'],
    "inserttable":    ['InsertTable',          'Tablo ekle',       'editor_action(this.id)',  'insert_table.gif'],
    "htmlmode":       ['HtmlMode',             'HTML kaynaðý',   'editor_setmode(\''+objname+'\')', 'ed_html.gif'],
    "popupeditor":    ['popupeditor',          'Editörü Özel Ekranda aç',     'editor_action(this.id)',  'fullscreen_maximize.gif'],
    "about":          ['about',                'Editör Hakkýnda',  'editor_about(\''+objname+'\')',  'ed_about.gif'],
